...
export const TYPOGRAPHY_TEMPLATES: CoverTemplate[] = [
  ...
  { id: 'Serif', name: 'Serif', title:'A classic font', image: 'assets/images/typography/serif.png' },
  { id: 'Modern', name: 'Modern', title:'A sophisticated font', image: 'assets/images/typography/modern.png' },
  { id: 'Timeless', name: 'Timeless', title:'A light and airy font', image: 'assets/images/typography/timless.png' },
  { id: 'Bold', name: 'Bold', title:'A punchy font', image: 'assets/images/typography/bold.png' },
  { id: 'Subtle', name: 'Subtle', title:'A minimal font', image: 'assets/images/typography/subtle.png' },
];
